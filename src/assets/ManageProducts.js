  ...
  return (
    <>
      ...
      {isOpen && (
          ...
          <div className="login-window-wrapper2">
            <div>
              <div className="about">
                <h2>Lisää tuote</h2>
              ...
              <div>
                <form onSubmit={handleFormSubmit}>
                  ...
                  <br />
                  <label htmlFor="password">Kategorian ID:</label><br />
                  ...
                  <br />
                  <br />
                  <button className="btn btn-outline-dark" type="submit">Lisää</button>
                  <button className="btn btn-outline-dark" onClick={() => setIsOpen(false)}>Peruuta</button>
                </form>
                </div>
              </div>
            </div>
